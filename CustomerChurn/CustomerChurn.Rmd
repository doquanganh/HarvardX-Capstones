...
### Gender
```{r Gender, echo=FALSE, include=TRUE}
...
### Geography
```{r Geography, echo=FALSE, include=TRUE}
...
### HasCrCard
```{r HasCrCard, echo=FALSE, include=TRUE}
...
### Is active member
```{r IsActiveMember, echo=FALSE, include=TRUE}
...
### Tenure
```{r Tenure, echo=FALSE, include=TRUE}
...
### NumOfProducts 
```{r NumOfProducts, echo=FALSE, include=TRUE}
...
### Age
```{r ggplot Tenure Continuous, echo=FALSE, include=TRUE}
...
### Balance
```{r ggplot Balance Continuous, echo=FALSE, include=TRUE}
...
### CreditScore
```{r ggplot CreditScore Continuous, echo=FALSE, include=TRUE}
...
### EstimatedSalary
```{r ggplot EstimatedSalary Continuous, echo=FALSE, include=TRUE}
...
```{r Data Cleansing , echo=FALSE, include=TRUE}
library(ROSE)
library(caret)
...
```{r one hot encoding , echo=FALSE, include=TRUE}
###  one hot encoding Geography and Gender dataframe
...
```{r imbalance data handling , echo=FALSE, include=TRUE}
...
```{r Training and Testing Split , echo=TRUE, include=TRUE}
...
```{r Formatted table, echo=FALSE, include=TRUE}
# Formatted table
results_comparisons %>%
...
## Feature Importance
```{r Feature Importance, echo=FALSE, include=TRUE}
# Feature Importance
