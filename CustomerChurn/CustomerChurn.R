...
#' ---
#' 
## ----Install Packages, include=FALSE, echo=FALSE-------------------------------------------------------------------------
...
#' 
## ----CHECKMISSING, echo=FALSE, include=TRUE------------------------------------------------------------------------------
...
#' ### Gender
## ----Gender, echo=FALSE, include=TRUE------------------------------------------------------------------------------------
...
#' 
#' ### Geography
## ----Geography, echo=FALSE, include=TRUE---------------------------------------------------------------------------------
...
#' 
#' ### HasCrCard
## ----HasCrCard, echo=FALSE, include=TRUE---------------------------------------------------------------------------------
...
#' 
#' ### Is active member
## ----IsActiveMember, echo=FALSE, include=TRUE----------------------------------------------------------------------------
...
#' 
#' ### Tenure
## ----Tenure, echo=FALSE, include=TRUE------------------------------------------------------------------------------------
...
#' 
#' ### NumOfProducts 
## ----NumOfProducts, echo=FALSE, include=TRUE-----------------------------------------------------------------------------
...
#' ### Age
## ----ggplot Tenure Continuous, echo=FALSE, include=TRUE------------------------------------------------------------------
...
#'  
#' ### Balance
## ----ggplot Balance Continuous, echo=FALSE, include=TRUE-----------------------------------------------------------------
...
#' 
#' ### CreditScore
## ----ggplot CreditScore Continuous, echo=FALSE, include=TRUE-------------------------------------------------------------
...
#' 
#' ### EstimatedSalary
## ----ggplot EstimatedSalary Continuous, echo=FALSE, include=TRUE---------------------------------------------------------
...
#' 
## ----exploreCorrelation, echo=FALSE, include=TRUE------------------------------------------------------------------------
#Correlations
...
## ----Data Cleansing , echo=FALSE, include=TRUE---------------------------------------------------------------------------
library(ROSE)
library(caret)
...
#' 
## ----one hot encoding , echo=FALSE, include=TRUE-------------------------------------------------------------------------
###  one hot encoding Geography and Gender dataframe
...
## ----imbalance data handling , echo=FALSE, include=TRUE------------------------------------------------------------------
...
## ----Training and Testing Split , echo=TRUE, include=TRUE----------------------------------------------------------------
...
#' ## Modeling
#' ### RandomForest
## ----randomForest, echo=FALSE, include=TRUE------------------------------------------------------------------------------
...
## ----Formatted table, echo=FALSE, include=TRUE---------------------------------------------------------------------------
# Formatted table
results_comparisons %>%
...
#' 
#' ## Feature Importance
## ----Feature Importance, echo=FALSE, include=TRUE------------------------------------------------------------------------
# Feature Importance
